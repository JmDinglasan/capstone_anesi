...
import 'package:capstone_anesi/orderModel.dart'
    as OrderModel; // Import the OrderModel class
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          unselectedLabelColor:
              Colors.grey, // Color for the unselected tabs (e.g., Non Cash)
                      ...
                      if (_cashInputController.text.isNotEmpty) {
                        setState(() {
                          _cashInputController.text = _cashInputController.text
                              .substring(
                                  0, _cashInputController.text.length - 1);
                        });
                      }
                    },
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: const Text(
                "There is no amount due. Please check the total bill."),
            actions: [
              TextButton(
                onPressed: () {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: const Text("Unsuccessful Payment"),
            content: const Text(
                "Insufficient amount. Please enter a sufficient amount."),
            actions: [
              TextButton(
                onPressed: () {
                  Navigator.of(context).pop();
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: const Text("Unsuccessful Payment"),
            content: const Text(
                "Entered amount too high. Please enter just the right amount."),
            actions: [
              TextButton(
                onPressed: () {
                  Navigator.of(context).pop();
...
void _completeOrder(
    BuildContext context, CartModel cartModel, String paymentMethod) {
